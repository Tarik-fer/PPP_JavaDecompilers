...
extends JDialog {
    ...
    public CElinksU(Frame parent, boolean modal) {
        super(parent, modal);
        this.initComponents();
    ...
    private void initComponents() {
        ...
        this.getContentPane().add((Component)this.jToolBar6, "Center");
        this.pack();
    ...
    public static void aboutRun() {
        EventQueue.invokeLater(new Runnable(){
            ...
            @Override
            public void run() {
                CElinksU dialog = new CElinksU(new JFrame(), true);
