...
/*     */ 
/*     */   
/* 102 */   protected boolean isHandledType(Class type) { return (String.class.isAssignableFrom(type) || int.class.isAssignableFrom(type) || long.class.isAssignableFrom(type) || boolean.class.isAssignableFrom(type) || Priority.class.isAssignableFrom(type)); }
/*     */   
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\config\PropertyGetter.class
