...
/*      */ 
/*      */   
/*  213 */   public void hide() { this._logMonitorFrame.setVisible(false); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  220 */   public DateFormatManager getDateFormatManager() { return this._table.getDateFormatManager(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  227 */   public void setDateFormatManager(DateFormatManager dfm) { this._table.setDateFormatManager(dfm); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  235 */   public boolean getCallSystemExitOnClose() { return this._callSystemExitOnClose; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  243 */   public void setCallSystemExitOnClose(boolean callSystemExitOnClose) { this._callSystemExitOnClose = callSystemExitOnClose; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  268 */   public void setMaxNumberOfLogRecords(int maxNumberOfLogRecords) { this._table.getFilteredLogTableModel().setMaxNumberOfLogRecords(maxNumberOfLogRecords); }
/*      */ 
/*      */ 
/*      */   
/*  272 */   public JFrame getBaseFrame() { return this._logMonitorFrame; }
/*      */ 
/*      */ 
/*      */   
/*  276 */   public void setTitle(String title) { this._logMonitorFrame.setTitle(title + " - LogFactor5"); }
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  291 */   public void setFontSize(int fontSize) { changeFontSizeCombo(this._fontSizeCombo, fontSize); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  297 */   public void addDisplayedProperty(Object messageLine) { this._displayedLogBrokerProperties.add(messageLine); }
/*      */ 
/*      */ 
/*      */   
/*  301 */   public Map getLogLevelMenuItems() { return this._logLevelMenuItems; }
/*      */ 
/*      */ 
/*      */   
/*  305 */   public Map getLogTableColumnMenuItems() { return this._logTableColumnMenuItems; }
/*      */ 
/*      */ 
/*      */   
/*  309 */   public JCheckBoxMenuItem getTableColumnMenuItem(LogTableColumn column) { return getLogTableColumnMenuItem(column); }
/*      */ 
/*      */ 
/*      */   
/*  313 */   public CategoryExplorerTree getCategoryExplorerTree() { return this._categoryExplorerTree; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  319 */   public String getNDCTextFilter() { return this._NDCTextFilter; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  326 */   public void setNDCLogRecordFilter(String textFilter) { this._table.getFilteredLogTableModel().setLogRecordFilter(createNDCLogRecordFilter(textFilter)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  334 */   protected void setSearchText(String text) { this._searchText = text; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  377 */   protected int getFirstSelectedRow() { return this._table.getSelectionModel().getMinSelectionIndex(); }
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  453 */   protected void refreshDetailTextArea() { refresh(this._table._detailTextArea); }
/*      */ 
/*      */ 
/*      */   
/*  457 */   protected void clearDetailTextArea() { this._table._detailTextArea.setText(""); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  646 */   protected void updateStatusLabel() { this._statusLabel.setText(getRecordsDisplayedMessage()); }
/*      */ 
/*      */   
...
/*      */           
/*  659 */           public String toString() { return LogBrokerMonitor.this.getRecordsDisplayedMessage(); }
/*      */            }
/*      */       );
...
/*  815 */     result.addActionListener(new ActionListener() { private final JMenuItem val$result; private final LogLevel val$logLevel; private final LogBrokerMonitor this$0;
/*      */           
...
/*      */           
/*  965 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.requestOpen(); }
/*      */            }
/*      */       );
/*  968 */     return result;
/*      */   }
...
/*      */           
/*  980 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.requestOpenURL(); }
/*      */            }
/*      */       );
/*  983 */     return result;
/*      */   }
...
/*      */           
/*  992 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.requestClose(); }
/*      */            }
/*      */       );
/*  995 */     return result;
/*      */   }
...
/*      */               
/* 1013 */               public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.requestOpenMRU(e); }
/*      */                }
/*      */           );
...
/*      */           
/* 1026 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.requestExit(); }
/*      */            }
/*      */       );
/* 1029 */     return result;
/*      */   }
...
/*      */           
/* 1047 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.saveConfiguration(); }
/*      */            }
/*      */       );
/*      */     
/* 1051 */     return result;
...
/*      */           
/* 1059 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.resetConfiguration(); }
/*      */            }
/*      */       );
/*      */     
/* 1063 */     return result;
...
/*      */           
/* 1071 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.setMaxRecordConfiguration(); }
/*      */            }
/*      */       );
/*      */     
/* 1075 */     return result;
...
/*      */ 
/*      */   
/* 1080 */   protected void saveConfiguration() { this._configurationManager.save(); }
/*      */ 
/*      */ 
/*      */   
/* 1084 */   protected void resetConfiguration() { this._configurationManager.reset(); }
/*      */ 
/*      */   
...
/*      */           
/* 1119 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.showPropertiesDialog("LogFactor5 Properties"); }
/*      */            }
/*      */       );
/* 1122 */     return result;
/*      */   }
/*      */ 
/*      */   
/* 1126 */   protected void showPropertiesDialog(String title) { JOptionPane.showMessageDialog(this._logMonitorFrame, this._displayedLogBrokerProperties.toArray(), title, -1); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */           
/* 1151 */           public void actionPerformed(ActionEvent e) { LogBrokerMonitor.this.findSearchText(); }
/*      */            }
/*      */       );
...
/*      */ 
/*      */   
/* 1552 */   protected Iterator getLogLevels() { return this._levels.iterator(); }
/*      */ 
/*      */ 
/*      */   
/* 1556 */   protected Iterator getLogTableColumns() { return this._columns.iterator(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1603 */     public LogBrokerMonitorWindowAdaptor(LogBrokerMonitor monitor) { this._monitor = monitor; }
/*      */ 
/*      */ 
/*      */     
/* 1607 */     public void windowClosing(WindowEvent ev) { this._monitor.requestClose(); }
/*      */   }
/*      */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\lf5\viewer\LogBrokerMonitor.class
