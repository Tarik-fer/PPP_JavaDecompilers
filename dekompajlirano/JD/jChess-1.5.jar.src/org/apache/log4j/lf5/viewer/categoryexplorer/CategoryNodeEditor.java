...
/*     */ 
/*     */   
/* 104 */   public Object getCellEditorValue() { return this._lastEditedNode.getUserObject(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 121 */   protected void showPropertiesDialog(CategoryNode node) { JOptionPane.showMessageDialog(this._tree, getDisplayedProperties(node), "Category Properties: " + node.getTitle(), -1); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 170 */     selectDescendants.addActionListener(new ActionListener() { private final CategoryNode val$node;
/*     */           private final CategoryNodeEditor this$0;
/*     */           
...
/*     */           private final CategoryNodeEditor this$0;
/*     */           
/* 187 */           public void actionPerformed(ActionEvent e) { CategoryNodeEditor.this._categoryModel.setDescendantSelection(node, false); }
/*     */         
/*     */         });
/*     */ 
/*     */     
...
/*     */ 
/*     */   
/* 272 */   protected void expand(CategoryNode node) { this._tree.expandPath(getTreePath(node)); }
/*     */ 
/*     */ 
/*     */   
/* 276 */   protected TreePath getTreePath(CategoryNode node) { return new TreePath((Object[])node.getPath()); }
/*     */ 
/*     */ 
/*     */   
/* 280 */   protected void collapse(CategoryNode node) { this._tree.collapsePath(getTreePath(node)); }
/*     */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\lf5\viewer\categoryexplorer\CategoryNodeEditor.class
