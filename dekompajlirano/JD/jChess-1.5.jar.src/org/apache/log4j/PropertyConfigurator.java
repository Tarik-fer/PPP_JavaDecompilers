...
/*     */ 
/*     */   
/* 403 */   public static void configure(String configFilename) { (new PropertyConfigurator()).doConfigure(configFilename, LogManager.getLoggerRepository()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 415 */   public static void configure(URL configURL) { (new PropertyConfigurator()).doConfigure(configURL, LogManager.getLoggerRepository()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 427 */   public static void configure(InputStream inputStream) { (new PropertyConfigurator()).doConfigure(inputStream, LogManager.getLoggerRepository()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 440 */   public static void configure(Properties properties) { (new PropertyConfigurator()).doConfigure(properties, LogManager.getLoggerRepository()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 455 */   public static void configureAndWatch(String configFilename) { configureAndWatch(configFilename, 60000L); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 673 */           parseAdditivityForLogger(props, logger, loggerName); continue;
/*     */         } 
...
/*     */ 
/*     */   
/* 936 */   void registryPut(Appender appender) { this.registry.put(appender.getName(), appender); }
/*     */ 
/*     */ 
/*     */   
/* 940 */   Appender registryGet(String name) { return (Appender)this.registry.get(name); }
/*     */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\PropertyConfigurator.class
