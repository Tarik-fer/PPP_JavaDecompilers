...
/*     */       try {
/* 138 */         s = null;
/* 139 */         Object[] elements = (Object[])getStackTraceMethod.invoke(t, s);
/* 140 */         String prevClass = "?";
/* 141 */         for (int i = elements.length - 1; i >= 0; i--) {
/* 142 */           String thisClass = (String)getClassNameMethod.invoke(elements[i], s);
/* 143 */           if (fqnOfCallingClass.equals(thisClass)) {
/* 144 */             int caller = i + 1;
/* 145 */             if (caller < elements.length) {
/* 146 */               this.className = prevClass;
/* 147 */               this.methodName = (String)getMethodNameMethod.invoke(elements[caller], s);
/* 148 */               this.fileName = (String)getFileNameMethod.invoke(elements[caller], s);
/* 149 */               if (this.fileName == null) {
/* 150 */                 this.fileName = "?";
/*     */               }
/* 152 */               int line = ((Integer)getLineNumberMethod.invoke(elements[caller], s)).intValue();
/* 153 */               if (line < 0) {
/* 154 */                 this.lineNumber = "?";
/*     */               } else {
...
/* 175 */         LogLog.debug("LocationInfo failed using JDK 1.4 methods", (Throwable)s);
/* 176 */       } catch (InvocationTargetException ex) {
/* 177 */         if (s.getTargetException() instanceof InterruptedException || s.getTargetException() instanceof java.io.InterruptedIOException)
/*     */         {
/* 179 */           Thread.currentThread().interrupt();
/*     */         }
/* 181 */         LogLog.debug("LocationInfo failed using JDK 1.4 methods", (Throwable)s);
/* 182 */       } catch (RuntimeException ex) {
/* 183 */         LogLog.debug("LocationInfo failed using JDK 1.4 methods", (Throwable)s);
/*     */       } 
/*     */     }
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\spi\LocationInfo.class
