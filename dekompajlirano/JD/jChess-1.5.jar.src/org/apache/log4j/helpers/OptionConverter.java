...
/* 463 */     Object object = null;
/*     */     
/* 465 */     if (clazz != null) {
/* 466 */       LogLog.debug("Preferred configurator class: " + clazz);
/* 467 */       object = instantiateByClassName(clazz, Configurator.class, null);
/*     */ 
/*     */       
/* 470 */       if (object == null) {
...
/*     */       } 
/*     */     } else {
/* 475 */       object = new PropertyConfigurator();
/*     */     } 
/*     */     
/* 478 */     object.doConfigure(inputStream, hierarchy);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 515 */       object = instantiateByClassName(clazz, Configurator.class, null);
/*     */ 
/*     */       
/* 518 */       if (object == null) {
...
/*     */       } 
/*     */     } else {
/* 523 */       object = new PropertyConfigurator();
/*     */     } 
/*     */     
/* 526 */     object.doConfigure(url, hierarchy);
/*     */   }
/*     */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\log4j\helpers\OptionConverter.class
