...
/*     */ 
/*     */   
/* 137 */   public static long freeSpace(String path) throws IOException { return INSTANCE.freeSpaceOS(path, OS, false); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 166 */   public static long freeSpaceKb(String path) throws IOException { return INSTANCE.freeSpaceOS(path, OS, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 317 */       flags = flags + "P";
/*     */     }
/* 319 */     (new String[3])[0] = "df"; (new String[3])[1] = flags; (new String[3])[2] = path; (new String[2])[0] = "df"; (new String[2])[1] = path; String[] cmdAttribs = (flags.length() > 1) ? new String[3] : new String[2];
/*     */ 
/*     */ 
/*     */     
...
/*     */       {
/* 419 */         throw new IOException("Command line returned OS error code '" + proc.exitValue() + "' for command " + Arrays.asList((T[])cmdAttribs));
/*     */       }
/*     */ 
/*     */       
/* 423 */       if (lines.size() == 0)
/*     */       {
/* 425 */         throw new IOException("Command line did not return any info for command " + Arrays.asList((T[])cmdAttribs));
/*     */       }
/*     */ 
/*     */       
/* 429 */       return lines;
...
/* 432 */       throw new IOException("Command line threw an InterruptedException '" + ex.getMessage() + "' for command " + Arrays.asList((T[])cmdAttribs));
/*     */     }
/*     */     finally {
/*     */       
...
/*     */ 
/*     */   
/* 454 */   Process openProcess(String[] cmdAttribs) throws IOException { return Runtime.getRuntime().exec(cmdAttribs); }
/*     */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\commons\io\FileSystemUtils.class
