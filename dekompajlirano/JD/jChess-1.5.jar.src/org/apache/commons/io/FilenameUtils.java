...
/*      */ 
/*      */   
/*  141 */   static boolean isSystemWindows() { return (SYSTEM_SEPARATOR == '\\'); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  152 */   private static boolean isSeparator(char ch) { return (ch == '/' || ch == '\\'); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  197 */   public static String normalize(String filename) { return doNormalize(filename, true); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  243 */   public static String normalizeNoEndSeparator(String filename) { return doNormalize(filename, false); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */         }
/*      */         
/*  317 */         int j = i - 4; while (true) { if (j >= prefix) {
...
/*      */ 
/*      */   
/*  649 */   public static String getPath(String filename) { return doGetPath(filename, 1); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  676 */   public static String getPathNoEndSeparator(String filename) { return doGetPath(filename, 0); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  727 */   public static String getFullPath(String filename) { return doGetFullPath(filename, true); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  757 */   public static String getFullPathNoEndSeparator(String filename) { return doGetFullPath(filename, false); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  833 */   public static String getBaseName(String filename) { return removeExtension(getName(filename)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  908 */   public static boolean equals(String filename1, String filename2) { return equals(filename1, filename2, false, IOCase.SENSITIVE); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  923 */   public static boolean equalsOnSystem(String filename1, String filename2) { return equals(filename1, filename2, false, IOCase.SYSTEM); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  939 */   public static boolean equalsNormalized(String filename1, String filename2) { return equals(filename1, filename2, true, IOCase.SENSITIVE); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  956 */   public static boolean equalsNormalizedOnSystem(String filename1, String filename2) { return equals(filename1, filename2, true, IOCase.SYSTEM); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1087 */   public static boolean wildcardMatch(String filename, String wildcardMatcher) { return wildcardMatch(filename, wildcardMatcher, IOCase.SENSITIVE); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1112 */   public static boolean wildcardMatchOnSystem(String filename, String wildcardMatcher) { return wildcardMatch(filename, wildcardMatcher, IOCase.SYSTEM); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */             }
/*      */           }
/* 1185 */           else if (!filename.startsWith(wcs[wcsIdx], textIdx)) {
/*      */             break;
/*      */           } 
/*      */ 
/*      */ 
...
/* 1232 */         if (array[i] == '?') {
/* 1233 */           list.add("?");
/* 1234 */         } else if (list.size() == 0 || (i > 0 && !list.get(list.size() - 1).equals("*"))) {
/*      */           
/* 1236 */           list.add("*");
/*      */         } 
/*      */       } else {
...
/*      */     }
/*      */     
/* 1246 */     return list.toArray(new String[list.size()]);
/*      */   }
/*      */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\apache\commons\io\FilenameUtils.class
