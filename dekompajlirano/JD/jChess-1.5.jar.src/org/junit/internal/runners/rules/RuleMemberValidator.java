...
/*     */ 
/*     */   
/* 104 */   private static Builder classRuleValidatorBuilder() { return new Builder(ClassRule.class); }
/*     */ 
/*     */ 
/*     */   
/* 108 */   private static Builder testRuleValidatorBuilder() { return new Builder(Rule.class); }
/*     */   
...
/*     */ 
/*     */     
/* 133 */     RuleMemberValidator build() { return new RuleMemberValidator(this); }
/*     */   }
/*     */ 
/*     */ 
/*     */   
/* 138 */   private static boolean isRuleType(FrameworkMember<?> member) { return (isMethodRule(member) || isTestRule(member)); }
/*     */ 
/*     */ 
/*     */   
/* 142 */   private static boolean isTestRule(FrameworkMember<?> member) { return TestRule.class.isAssignableFrom(member.getType()); }
/*     */ 
/*     */ 
/*     */   
/* 146 */   private static boolean isMethodRule(FrameworkMember<?> member) { return MethodRule.class.isAssignableFrom(member.getType()); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 212 */     private boolean isDeclaringClassPublic(FrameworkMember<?> member) { return Modifier.isPublic(member.getDeclaringClass().getModifiers()); }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\junit\internal\runners\rules\RuleMemberValidator.class
