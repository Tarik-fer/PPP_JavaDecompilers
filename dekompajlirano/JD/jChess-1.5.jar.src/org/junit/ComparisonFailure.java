...
/*     */ 
/*     */   
/*  49 */   public String getMessage() { return (new ComparisonCompactor(20, this.fExpected, this.fActual)).compact(super.getMessage()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  58 */   public String getActual() { return this.fActual; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  67 */   public String getExpected() { return this.fExpected; }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */       
/* 144 */       public String expectedDiff() { return extractDiff(ComparisonFailure.ComparisonCompactor.this.expected); }
/*     */ 
/*     */ 
/*     */       
/* 148 */       public String actualDiff() { return extractDiff(ComparisonFailure.ComparisonCompactor.this.actual); }
/*     */ 
/*     */       
...
/*     */ 
/*     */       
/* 166 */       private String extractDiff(String source) { return "[" + source.substring(this.sharedPrefix.length(), source.length() - this.sharedSuffix.length()) + "]"; }
/*     */       
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\junit\ComparisonFailure.class
