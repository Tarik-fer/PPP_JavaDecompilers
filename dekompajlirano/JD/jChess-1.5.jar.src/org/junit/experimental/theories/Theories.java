...
/*     */ {
/*  73 */   public Theories(Class<?> klass) throws InitializationError { super(klass); }
/*     */ 
/*     */ 
/*     */   
...
/*  87 */       if (field.getAnnotation((Class)DataPoint.class) != null || field.getAnnotation((Class)DataPoints.class) != null) {
/*     */ 
/*     */         
...
/* 103 */       if (method.getAnnotation((Class)DataPoint.class) != null || method.getAnnotation((Class)DataPoints.class) != null) {
/*     */ 
/*     */         
...
/*     */ 
/*     */   
/* 117 */   protected void validateConstructor(List<Throwable> errors) { validateOnlyOneConstructor(errors); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 165 */   public Statement methodBlock(FrameworkMethod method) { return new TheoryAnchor(method, getTestClass()); }
/*     */   
...
/*     */ 
/*     */     
/* 182 */     private TestClass getTestClass() { return this.testClass; }
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 218 */     protected void runWithCompleteAssignment(final Assignments complete) throws Throwable { (new BlockJUnit4ClassRunner(getTestClass().getJavaClass())
/*     */         {
/*     */           protected void collectInitializationErrors(List<Throwable> errors) {}
/*     */ 
/*     */ 
...
/*     */ 
/*     */           
/* 247 */           protected Statement methodInvoker(FrameworkMethod method, Object test) { return Theories.TheoryAnchor.this.methodCompletesWithParameters(method, complete, test); }
/*     */ 
/*     */ 
/*     */           
...
/*     */ 
/*     */     
/* 280 */     protected void handleAssumptionViolation(AssumptionViolatedException e) { this.fInvalidParameters.add(e); }
/*     */ 
/*     */ 
/*     */     
...
/* 293 */       Theory annotation = this.testMethod.getMethod().getAnnotation(Theory.class);
/*     */       
...
/*     */ 
/*     */     
/* 302 */     protected void handleDataPointSuccess() { this.successes++; }
/*     */   }
/*     */ }


/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\junit\experimental\theories\Theories.class
