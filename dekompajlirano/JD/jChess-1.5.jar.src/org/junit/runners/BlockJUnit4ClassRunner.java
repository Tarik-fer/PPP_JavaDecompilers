...
/*     */ 
/*     */   
/*  65 */   public BlockJUnit4ClassRunner(Class<?> klass) throws InitializationError { super(klass); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  88 */   protected boolean isIgnored(FrameworkMethod child) { return (child.getAnnotation(Ignore.class) != null); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 106 */   protected List<FrameworkMethod> getChildren() { return computeTestMethods(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 119 */   protected List<FrameworkMethod> computeTestMethods() { return getTestClass().getAnnotatedMethods(Test.class); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 176 */   private boolean hasOneConstructor() { return ((getTestClass().getJavaClass().getConstructors()).length == 1); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 196 */   protected void validateFields(List<Throwable> errors) { RuleMemberValidator.RULE_VALIDATOR.validate(getTestClass(), errors); }
/*     */ 
/*     */ 
/*     */   
/* 200 */   private void validateMethods(List<Throwable> errors) { RuleMemberValidator.RULE_METHOD_VALIDATOR.validate(getTestClass(), errors); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 208 */   protected void validateTestMethods(List<Throwable> errors) { validatePublicVoidNoArgMethods((Class)Test.class, false, errors); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 217 */   protected Object createTest() throws Exception { return getTestClass().getOnlyConstructor().newInstance(new Object[0]); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 225 */   protected String testName(FrameworkMethod method) { return method.getName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 290 */   protected Statement methodInvoker(FrameworkMethod method, Object test) { return (Statement)new InvokeMethod(method, test); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 372 */   private List<MethodRule> getMethodRules(Object target) { return rules(target); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 400 */   private Statement withTestRules(FrameworkMethod method, List<TestRule> testRules, Statement statement) { return testRules.isEmpty() ? statement : (Statement)new RunRules(statement, testRules, describeChild(method)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 428 */   private boolean expectsException(Test annotation) { return (getExpectedException(annotation) != null); }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\junit\runners\BlockJUnit4ClassRunner.class
