...
/*     */     {
/*  71 */       public void schedule(Runnable childStatement) { childStatement.run(); }
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */ 
/*     */   
/*  88 */   protected TestClass createTestClass(Class<?> testClass) { return new TestClass(testClass); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 281 */   protected boolean isIgnored(T child) { return false; }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 303 */   protected String getName() { return this.testClass.getName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 314 */   public final TestClass getTestClass() { return this.testClass; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 340 */   protected Annotation[] getRunnerAnnotations() { return this.testClass.getAnnotations(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */           try {
/* 384 */             filter.apply(each); continue;
...
/*     */ 
/*     */   
/* 434 */   private boolean shouldRun(Filter filter, T each) { return filter.shouldRun(describeChild(each)); }
/*     */ 
/*     */   
/*     */   private Comparator<? super T> comparator(final Sorter sorter) {
/* 438 */     return new Comparator<T>()
/*     */       {
/* 440 */         public int compare(T o1, T o2) { return sorter.compare(ParentRunner.this.describeChild(o1), ParentRunner.this.describeChild(o2)); }
/*     */       };
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 450 */   public void setScheduler(RunnerScheduler scheduler) { this.scheduler = scheduler; }
/*     */   
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\junit\runners\ParentRunner.class
