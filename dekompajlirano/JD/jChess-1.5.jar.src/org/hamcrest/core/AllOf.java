...
/*     */   
/*  21 */   public AllOf(Iterable<Matcher<? super T>> matchers) { this.matchers = matchers; }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  38 */   public void describeTo(Description description) { description.appendList("(", " and ", ")", this.matchers); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Factory
/*  49 */   public static <T> Matcher<T> allOf(Iterable<Matcher<? super T>> matchers) { return (Matcher<T>)new AllOf<T>(matchers); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   @Factory
/*  60 */   public static <T> Matcher<T> allOf(Matcher<? super T>... matchers) { return allOf(Arrays.asList(matchers)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Tarik\OneDrive - fer.hr\FAKS\5. semestar\PPP\Testiranje\Test programi\jChess-1.5\jChess-1.5\jChess-1.5.jar!\org\hamcrest\core\AllOf.class
