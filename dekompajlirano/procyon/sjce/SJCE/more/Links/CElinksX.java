...
public class CElinksX extends JDialog
{
    ...
    public CElinksX(final Frame parent, final boolean modal) {
        super(parent, modal);
        this.returnStatus = 0;
        this.initComponents();
    ...
    private void initComponents() {
        ...
        this.getContentPane().add(this.jToolBar3, "North");
        this.pack();
    ...
    public static void aboutRun() {
        EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                final CElinksX dialog = new CElinksX(new JFrame(), true);
