...
public class LockableFileWriter extends Writer
{
    ...
    private void createLock() throws IOException {
        Class class$;
        Class class$org$apache$commons$io$output$LockableFileWriter;
        if (LockableFileWriter.class$org$apache$commons$io$output$LockableFileWriter == null) {
            class$org$apache$commons$io$output$LockableFileWriter = (LockableFileWriter.class$org$apache$commons$io$output$LockableFileWriter = (class$ = class$("org.apache.commons.io.output.LockableFileWriter")));
        }
        else {
            class$ = (class$org$apache$commons$io$output$LockableFileWriter = LockableFileWriter.class$org$apache$commons$io$output$LockableFileWriter);
        }
        final Class clazz = class$org$apache$commons$io$output$LockableFileWriter;
        synchronized (class$) {
