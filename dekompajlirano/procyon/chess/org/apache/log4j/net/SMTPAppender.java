...
public class SMTPAppender extends AppenderSkeleton implements UnrecognizedElementHandler
{
    ...
    protected Session createSession() {
        ...
        if (this.smtpProtocol != null) {
            ((Hashtable<String, String>)props).put("mail.transport.protocol", this.smtpProtocol);
            prefix = "mail." + this.smtpProtocol;
        }
        if (this.smtpHost != null) {
            ((Hashtable<String, String>)props).put(prefix + ".host", this.smtpHost);
        }
        if (this.smtpPort > 0) {
            ((Hashtable<String, String>)props).put(prefix + ".port", String.valueOf(this.smtpPort));
        }
        Authenticator auth = null;
        if (this.smtpPassword != null && this.smtpUsername != null) {
            ((Hashtable<String, String>)props).put(prefix + ".auth", "true");
